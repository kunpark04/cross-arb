...
**Unified + persistence**
- `selftest_all.py` — **run EVERY offline self-test in the repo** (4 bot cores + 13 script selftests) in one command with a PASS/FAIL table; non-zero exit on any failure. The pre-commit / pre-deploy gate. ⭐
