...
def report(edges, exit_haircut):
    ...
    L += ["",
          ...
          "  Weather is the opposite: closes LATE (~2am ET, after the ~6pm high-lock) so it HAS a ~8h evening exit",
          "  window (measured: winning bucket bid ~0.98-0.99, deep) -- though at a ~1.2d natural settle, barely needed.",
