...
· cross-venue **mid-divergence** (L1 bad-join/stale guard) · non-positive edge (L11) · opt-in edge floor
(L15) · per-pair / per-cluster (city-date, game) / total notional caps · concurrency cap · depth- and
