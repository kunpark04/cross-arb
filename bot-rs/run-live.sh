...
export REQUIRE_SETTLE_CLEAN=true ASSUME_SPORTS_SETTLED=false ASSUME_ECON_SETTLED=false CROSSARB_KILL=0
...
export EDGE_FLOOR_CENTS=2.0 MIN_EDGE_RATE_CPD=1.0 MAX_DAYS_TO_EVENT=2.0
...
echo "[run-live] LIVE prod, cap=${MAX_POSITIONS_PER_SLUG}, pmus armed — launching" >&2
