...
> **CORRECTION (2026-06-08):** This brief's **econ** verdict below — "roadmap, not-listed / would-be-same-source / international-only and therefore US-illegal" — is **SUPERSEDED by `us-legal-overlap-audit.md`**. A same-day live `gateway.polymarket.us/v1` pull (`scripts/_data/pmus_open_markets.json`) found **36 live macro markets** on polymarket.us — **CPI, Fed, GDP, NFP, U-3** — each settling on the same **BLS / BEA / Fed** print Kalshi uses. **Econ IS live and US-legal on polymarket.us**; the "not-listed" reading below was a documentation/FAQ-lag artifact (no econ FAQ page existed yet), **not** an absence of listings. **Crypto** remains correctly absent (no live polymarket.us crypto markets in the same pull) — the crypto verdicts below stand.
...
1. **Does polymarket.us list the high-value families (weather / crypto / econ)?**
   ...
   - **Econ: YES — LIVE and US-legal on polymarket.us.** *(Corrected 2026-06-08 — see top banner; the original "announced/rolling-out, not confirmed-listed" reading below was a documentation/FAQ-lag artifact.)* A same-day live `gateway.polymarket.us/v1` pull found **36 live macro markets** (CPI, Fed, GDP, NFP, U-3), each settling on the same **BLS/BEA/Fed** print Kalshi uses. The missing econ FAQ page caused the doc-lag, not an absence of listings. [VERIFIED via live pull — `us-legal-overlap-audit.md`]
   - **Crypto: roadmap family, not confirmed-listed on the *US venue*.** Polymarket has publicly stated crypto is part of the rollout and the API category filter is open-ended, but I could **not find a polymarket.us-specific crypto contract spec / FAQ** (the `crypto-faqs` page 404s) and the same-day live pull found **no live polymarket.us crypto markets**. Most "BTC $XX traded" figures in search are **international polymarket.com**, not polymarket.us. Treat crypto on polymarket.us as **announced/rolling-out, not confirmed-listed**. [PARTIAL / UNVERIFIED for the US venue specifically]
...
| **Econ (CPI / FOMC / GDP / NFP)** | **LIVE and US-legal on polymarket.us** *(corrected 2026-06-08 — see top banner; the prior "not confirmed / roadmap" reading was a doc/FAQ-lag artifact, not absence of listings).* A same-day live pull found **36 live macro markets** (CPI, Fed, GDP, NFP, U-3) settling on the **same BLS/BEA/Fed prints as Kalshi** → a candidate clean arb (episodic, around scheduled releases). **Classification: US-legal, same-source, confirmed-listed — strongest clean subset; grid/boundary alignment per release still to verify.** [VERIFIED — `us-legal-overlap-audit.md`] |
...
**Net** *(corrected 2026-06-08 — see top banner):* The families that are simultaneously (a) confirmed-listed on polymarket.us, (b) settled on the same government source as Kalshi, and (c) deterministic (no UMA) are **WEATHER and ECON** (CPI/Fed/GDP/NFP/U-3, found live in the same-day pull, settling on BLS/BEA/Fed) — **econ is the structurally cleanest subset** (identical government number, episodic). Weather is contingent on closing the bucket-grid and per-city-station checks. **Crypto** — the remaining high-value family — is **not yet confirmable on the US venue**, so for crypto the strategy remains **international-only and therefore US-illegal** for now.
